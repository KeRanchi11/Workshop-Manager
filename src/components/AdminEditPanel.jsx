    ...
    return (
        <Container className="mt-5">
            ...
            <Table bordered>
                <thead>
                    <tr>
                        <th className="text-center align-middle">فاز</th>
                        <th className="text-center align-middle">ماده اولیه</th>
                        <th className="text-center align-middle">انتخاب تاریخ‌ها</th>
                        <th className="text-center align-middle">تاریخ‌های انتخاب‌شده و مقدار مواد اولیه</th>
                    </tr>
                </thead>
                <tbody>
                    {phases.map((phase) => (
                        <tr key={phase.phase}>
                            <td className="text-center align-middle">{phase.phase}</td>
